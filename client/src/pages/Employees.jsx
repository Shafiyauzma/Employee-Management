...
const Employees = () => {
  ...
  const fetchEmployees = useCallback(async ()=>{
    try {
      const url = selectedDept ? `/employees?departments=${selectedDept}` : "/employees";
  ...
  return (
    <div className="animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 sm:gap-5">
          {filtered.length === 0 ? (
