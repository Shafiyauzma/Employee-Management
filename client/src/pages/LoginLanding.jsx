  ...
  const portalOptions = [
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Manage employees, depeatments, payroll, and system configurations.",
      icon: ShieldIcon
    },
    {
      to: "/login/employee",
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        {/* Header */}
        <div className="mb-10 text-center md:text-LoginLeftSide">
          <h2 className="text-3xl font-medium text-slate-900 tracking-tight mb-3">Welcome Back</h2>
          <p className="text-slate-500">Select your portal to securly access the system.</p>
        </div>
        ...
        <div className="mt-12 text-center md:text-left text-sm text-slate-400">
          <p>@ {new Date().getFullYear()} Shafiya. All rights reserved</p>
        </div>
